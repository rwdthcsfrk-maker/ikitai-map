...
export const places = mysqlTable("places", {
  ...
  genreParent: varchar("genreParent", { length: 50 }),
  genreChild: varchar("genreChild", { length: 50 }),
  budgetLunch: varchar("budgetLunch", { length: 20 }),
  budgetDinner: varchar("budgetDinner", { length: 20 }),
